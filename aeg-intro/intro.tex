...
\begin{figure}[ht]\centering
\resizebox{0.7\textwidth}{!}{\includegraphics{images/param_curve}}
\end{figure}
\end{frame}
...
\begin{figure}[ht]\centering
\resizebox{0.6\textwidth}{!}{\includegraphics{images/brachistochrone}}
\end{figure}
\end{frame}
...
\begin{figure}[ht]\centering
\resizebox{0.6\textwidth}{!}{\includegraphics{images/expr_1st}}
\end{figure}
\end{frame}
...
\begin{figure}[ht]\centering
\resizebox{0.6\textwidth}{!}{\includegraphics{images/generating}}
\end{figure}
\end{frame}
...
\frametitle{Trap}
\begin{figure}[ht]\centering
\resizebox{0.6\textwidth}{!}{\includegraphics{images/peak-vally}}
\end{figure}
\end{frame}
...
\begin{figure}[ht]\centering
\resizebox{0.6\textwidth}{!}{\includegraphics{images/one-way-reachable}}
\end{figure}
\end{frame}
...
\begin{figure}[ht]\centering
\resizebox{0.9\textwidth}{!}{\includegraphics{images/expr1st-results}}
\end{figure}
\end{frame}
...
\begin{figure}[ht]\centering
\resizebox{0.6\textwidth}{!}{\includegraphics{images/bifurcation}}
\end{figure}
\end{frame}
...
\frametitle{Experiment results}
\begin{figure}[ht]\centering
\resizebox{0.6\textwidth}{!}{\includegraphics{images/expr2nd-results1}}
\end{figure}
\end{frame}
...
\frametitle{Hebbian?}
\begin{figure}[ht]\centering
\resizebox{0.9\textwidth}{!}{\includegraphics{images/expr2nd-results2}}
\end{figure}
\end{frame}
...
\begin{figure}[ht]\centering
\resizebox{0.5\textwidth}{!}{\includegraphics{images/jigsaw}}
\end{figure}
\end{frame}
...
\begin{figure}[ht]\centering
\resizebox{0.7\textwidth}{!}{\includegraphics{images/jigsaw-riemann}}
\end{figure}
\end{frame}
...
\begin{figure}[ht]\centering
\resizebox{0.7\textwidth}{!}{\includegraphics{images/tube}}
\end{figure}
\end{frame}
