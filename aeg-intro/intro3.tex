...
\begin{frame}
    \frametitle{The Descartes form of flow equation}
\end{frame}

\begin{frame}
    \frametitle{The contour-gradient form of flow equation}
    Contour and gradient lines are orthogonal, so they can form a basis, the flow equation can be re-written as
    \begin{equation}
    ...
    The contour-gradient form is important in the study of duals, Laplacian and its eigenfunction.
\end{frame}

\begin{frame}
    \frametitle{Aritmetic torision}
\end{frame}
...
\begin{frame}
    \frametitle{Local existance}
\end{frame}

\begin{frame}
    \frametitle{Global existance}
    \begin{figure}[ht]\centering
...
\begin{frame}
    \frametitle{Arbitrary curvature?}
\end{frame}
...
\begin{frame}
    \frametitle{Analysis category?}
    From the abstract point of view, we can formulate our systems as a tuple of
    \begin{itemize}
    ...
    \end{itemize}
    Can we form a category?
\end{frame}

\begin{frame}
    \frametitle{Sigularity}
\end{frame}
