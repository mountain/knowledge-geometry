...
\begin{tikzpicture}
    ...
    \tkzDrawArc[R with nodes,color=green](K1,\rAp)(C,D)
    \tkzDrawArc[R with nodes,color=blue](K1,1.8)(O1,O2)
    ...
    \tkzDrawCircle[R,fill=black](A,0.02)
    \tkzDrawCircle[R,fill=black](O,0.02)
    \tkzDrawCircle[R,fill=black](X,0.02)
