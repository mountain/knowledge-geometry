...
但数值计算和模拟支持上述设想，可以参看图 \ref{fig:apeirogon}，在图中可以观察到我们设想的二等分角的序列，以及y坐标上的等比数列。
...
如果能严格论证清楚管型构造的存在，它必定是一个极端重要的数学对象。

交换子是否可以用来计算曲率呢？对某些适用的流形，零线是否有助于计算基本域？能否用来做单值化？
能否为几何研究本身开辟新的计算途径？
...
通过邱奇编码，我们直接可以把算术表达式空间变成程序的几何空间。
...
在《通向实在之路》一书的开篇，R. Penrose 指出了神秘的三重世界和它们之间的投射。
\begin{itemize}
    \item 物理世界
    \item 心智世界
    \item 柏拉图的数学世界
...
我们认为沉潜下去，去寻找新的思想和方向是我们这一代人的任务。

\begin{figure}[ht]
\centering
\includegraphics[width=4in]{images/landscape.png}
\caption{向下去思考}
\end{figure}
