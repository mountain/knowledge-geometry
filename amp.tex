...
$\begin{array}{|c|c|}\hline0&\space\\\hline 1&0\\\hline\end{array} \mapsto h$ 代表全体横向测地线（加线），可以用来做过滤器

$\begin{array}{|c|c|}\hline0&\space\\\hline 0&1\\\hline\end{array} \mapsto i$ 代表全体横向测地线（加线）上的自然增加

$$
\begin{array}{|c|c|}\hline1&\space\\\hline n&1\\\hline\end{array} \mapsto j_n
$$

$$
\begin{array}{|c|c|}\hline2&\space\\\hline 1&0\\\hline\end{array} \mapsto p
$$
...
$\begin{array}{|c|c|}\hline0&\space\\\hline n&0\\\hline\end{array} \mapsto o_n = n o$

$\begin{array}{|c|c|}\hline0&\space\\\hline n&1\\\hline\end{array} \mapsto i_n = n + j $


问题：


$\begin{array}{|c|c|}\hline ?&\space\\\hline ?&?\\\hline\end{array} \mapsto v$ 纵向测地线（乘线）存在过滤器吗？
