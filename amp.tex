...
\begin{tikzpicture}
    ...
    \draw [blue, dotted, thick]
          (-1.89, -7.39) node[circle, fill=blue, inner sep=1pt] (p_pinf) {}
       -- (+0.30, +1.35) node[circle, fill=blue, inner sep=1pt] (p_1) {$\odot$ 1}
       -- (+1.89, +7.39) node[circle, fill=blue, inner sep=1pt] (p_ninf) {};
