...
\begin{tikzpicture}
    \draw [red, thick]
          (0.00, 0.00) arc (-180.0:+180.0:4.50);
    \draw [black, thick]
          (+2.50, -4.05) arc (-37.0:+44.0:6.00);
    \draw (+2.50, -4.55) node[inner sep=1pt] (a) {$a$};
    \draw (+2.50, -4.05) node[inner sep=1pt] (a_) {$\bullet$};
    \draw (+3.20, -1.00) node[inner sep=1pt] (p) {$p$};
    \draw (+3.70, -1.00) node[inner sep=1pt] (p_) {$\bullet$};
    \draw (+3.90, +1.20) node[inner sep=1pt] (q) {$q$};
    \draw (+3.50, +1.20) node[inner sep=1pt] (q_) {$\bullet$};
    \draw (+1.90, +4.20) node[inner sep=1pt] (b) {$b$};
    \draw (+2.00, +3.75) node[inner sep=1pt] (b_) {$\bullet$};
\end{tikzpicture}
\caption{通过交比引入距离}
\end{figure}
...
$$d(p,q)= \log \frac{ \left| aq \right| \, \left| pb \right| }{ \left| ap \right| \, \left| qb \right| }$$
