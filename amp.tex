...
\begin{tikzpicture}
    ...
    \draw (+1.89, +7.89) node[inner sep=1pt] (p_n) {$-\infty$};
    \draw (+0.90, +5.50) node[inner sep=1pt] (p_0) {0};
    \draw (+0.00, +1.85) node[inner sep=1pt] (p_1) {1};
    \draw (-0.82, -1.10) node[inner sep=1pt] (p_2) {2};
    \draw (-1.35, -3.50) node[inner sep=1pt] (p_2) {3};
    \draw (-1.89, -7.89) node[inner sep=1pt] (p_p) {$+\infty$};
