...
\node[anchor=-245, black, font=\fontsize{5}{5}\selectfont] at (-8,8) {$1$};
\node[circle,fill=black,inner sep=1pt,minimum size=3pt] (b) at (-8,4) {};
\node[anchor=-245, black, font=\fontsize{5}{5}\selectfont] at (-8,4) {$1 \times 2$};
\node[circle,fill=black,inner sep=1pt,minimum size=3pt] (a) at (-8,2) {};
\node[anchor=-245, black, font=\fontsize{5}{5}\selectfont] at (-8,2) {$1 \times 2 \times 2$};
\node[circle,fill=black,inner sep=1pt,minimum size=3pt] (a) at (-6,2) {};
\node[anchor=-245, black, font=\fontsize{5}{5}\selectfont] at (-6,2) {$1 \times 2 \times 2 - 1$};
\node[circle,fill=black,inner sep=1pt,minimum size=3pt] (a) at (-6,1) {};
\node[anchor=-245, black, font=\fontsize{5}{5}\selectfont] at (-6,1) {$(1 \times 2 \times 2 - 1) \times 2$};
\node[circle,fill=black,inner sep=1pt,minimum size=3pt] (a) at (-3,1) {};
\node[anchor=-245, black, font=\fontsize{5}{5}\selectfont] at (-3,1) {$(1 \times 2 \times 2 - 1) \times 2 - 3$};
...
从上节我们知道可线索化表达式对应一条几何上的路径，下面通过几何上路径的逆，引入可线索化表达式的逆运算。
...
\node[circle,fill=red,inner sep=1pt,minimum size=3pt] (b) at (-8,8) {};
\node[anchor=-245, black, font=\fontsize{5}{5}\selectfont] at (-8,8) {$((3 + 3) \div 2 + 1) \div 2 \div 2$};
\node[circle,fill=red,inner sep=1pt,minimum size=3pt] (b) at (-8,4) {};
\node[anchor=-245, black, font=\fontsize{5}{5}\selectfont] at (-8,4) {$((3 + 3) \div 2 + 1) \div 2$};
\node[circle,fill=red,inner sep=1pt,minimum size=3pt] (a) at (-8,2) {};
\node[anchor=-245, black, font=\fontsize{5}{5}\selectfont] at (-8,2) {$(3 + 3) \div 2 + 1$};
\node[circle,fill=red,inner sep=1pt,minimum size=3pt] (a) at (-6,2) {};
\node[anchor=-245, black, font=\fontsize{5}{5}\selectfont] at (-6,2) {$(3 + 3) \div 2$};
\node[circle,fill=red,inner sep=1pt,minimum size=3pt] (a) at (-6,1) {};
\node[anchor=-245, black, font=\fontsize{5}{5}\selectfont] at (-6,1) {$3 + 3$};
\node[circle,fill=red,inner sep=1pt,minimum size=3pt] (a) at (-3,1) {};
\node[anchor=-245, black, font=\fontsize{5}{5}\selectfont] at (-3,1) {$3$};
\draw [red, line width=1.2pt] (-8,7.7) to[out=90,in=270] (-8,2.3);
\draw [red, line width=1.2pt] (-8,2) to[out=0,in=180] (-6,2);
\draw [red, line width=1.2pt] (-6,1.95) to[out=90,in=270] (-6,1.05);
\draw [red, line width=1.2pt] (-6,1) to[out=0,in=180] (-3,1);
\end{tikzpicture}
\caption{加乘网格上的一条逆路径（红色粗线）}\label{fig:pathex1}
\end{figure}
...
\begin{scope}[line width=0.3pt]
    ...
    \tkzDrawCircle[R,fill=black](O,0.05 pt)
    \tkzDrawCircle[R,fill=black](P,0.05 pt)
    \tkzDrawCircle[R,fill=black](Q,0.05 pt)
    \tkzDrawCircle[R,fill=black](R,0.05 pt)
    \tkzDrawCircle[R,fill=black](S,0.05 pt)
    \tkzLabelPoint[below left](O){$O$}
...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}
        \begin{scope}[line width=0.3pt]
            \draw (0, 0) node[inner sep=0] {\includegraphics[width=3.41in]{images/horocycles.png}};
            \tkzDefPoint(0,0){O}
