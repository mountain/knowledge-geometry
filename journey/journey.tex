...
\begin{equation}
    u (\mu \cos \theta + x \lambda \sin \theta) = 0
\end{equation}
...
表征，它会极大的提升我们的能力。这也就是算术表达式几何化的意义所在。它有潜力可以把分离
的几何、分析和计算这三个学科重新黏合在一起。

同时，它能从另一个⻆度回应当下的学习问题。
在目前的计算机科学里，人们大多讨论停机的程序。停机程序，我们可以清晰定义它的作用，从而 分析这一类程序的性质。
