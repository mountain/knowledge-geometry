...
\[
\mathbf{a} \cdot \mathbf{b} = \begin{bmatrix} a_x & a_y \end{bmatrix} \begin{bmatrix} \frac{1}{y^2} & 0 \\ 0 & \frac{1}{\ln^2{2} y^2} \end{bmatrix} \begin{bmatrix} b_x \\ b_y \end{bmatrix}
\]
...
容易看到，这个赋值有半圆形的等值线，而它的梯度场是从原点出发的射线。
