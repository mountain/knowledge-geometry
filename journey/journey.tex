...
在上节我们得到公式，
\begin{equation}
\alpha(w_0) = \mu (e^{\lambda k_l} m_0 + e^{\lambda k_{l - 1}} m_1  + e^{\lambda k_{l - 1}} m_2 + \cdots + e^{\lambda k_1} m_{l-1} + e^{\lambda k_0} m_l)
\end{equation}

于是有
\begin{equation}
\alpha(w_0) = \mu e^{\lambda k_l} m_0 + \mu (e^{\lambda k_{l - 1}} m_1  + e^{\lambda k_{l - 1}} m_2 + \cdots + e^{\lambda k_1} m_{l-1} + e^{\lambda k_0} m_l)
\end{equation}

我们还可以对它变形
\begin{equation}
\alpha(w_0) = e^{\lambda k_l} ( \mu m_0 + \mu m_1 e^{\lambda (k_{l - 1} - k_l)} + \mu m_2 e^{\lambda (k_{l - 1} - k_l)}+ \cdots + \mu m_{l-1} e^{\lambda (k_1 - k_l)}  + \mu m_l e^{\lambda (k_0 - k_l)})
\end{equation}

如何从这些标准的形式里得到几何？这是要仔细考察的问题。
