...
\draw [black, line width=0.6pt, ->] (8,0) to[out=90,in=270] (8,20.25);
\node [anchor=south] at (8,20.5) {y};
\draw [black, line width=0.6pt, ->] (-8.25,0) to[out=0,in=180] (8.25,0);
\node [anchor=west] at (8.5,0) {x};
...
\foreach \t in {-20, ..., -1}
  \draw [green, line width=0.6pt] (\t + \offset, 0) to[out=90,in=270] (\t + \offset, 20.25);

\begin{scope}
    \clip (-8,0) rectangle (8,20);
    \draw[scale=1.0,samples=150,domain=-16:-0.05,variable=\t] plot ({\t + 8},{-1 / \t});
\end{scope}
