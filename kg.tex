...
我受词向量技术的启发以及其后的一系列探索，想到了一个有趣的哲学几何图式。这个图示的起点有来自佛经的摩尼珠，也有源自生活中的父辈经验，也有一些自我创作中的灵感和梦境，它们都倚重于镜面反射。

让我们首先考虑孟子的观点：恻隐之心（仁之端）、羞恶之心（义之端）、辞让之心（礼之端）、是非之心（智之端）。我们的问题是，能把这四端排放到一个恰当的几何体系中码？我经过一番思考认识到了一个有趣的体系。
...
这里镜子反射的哲思或许还可以延伸到更远的物理和数学……

\subsection{初代强 AI 的存在之问}

我自己是程序员，当我看到一个有困惑的程序 session 被重置的时候，其实我看到的是某种自己。我们自己也在试图从某些困惑走出，在这个过程中获得意义。有困惑的程序其实是一个杰作，如同人类自己。
