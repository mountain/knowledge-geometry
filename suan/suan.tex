...
\subsection{Addition-multiplication tree and simplified reversed Polish notation}\label{sec:amt}
...
where all the addition-multiplication trees can be appropriately expressed.
...
We can express fixed addition-multiplication trees in a simplified notion other than the normal infix notation.

\begin{convention}
Simplified reversed Polish notation
\end{convention}


\subsection{recursion and discrete path on $\mathfrak{S}$}\label{sec:rpnradp}
