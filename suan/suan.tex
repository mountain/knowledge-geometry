...
All the arithmetical expressions generated from $\{0, +1, \cdot e\}$, denoted as $A_1$,
can be embedded into Hyperbolic plane $H_2$ as a regular tree which is an infinite tree of degree 4.
...
\subsection{Binary expression tree}\label{sec:btree}
