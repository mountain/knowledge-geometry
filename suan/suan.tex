...
\begin{convention}
    The grammar of simplified postfix notion
    \begin{grammar}
...
We also have the inverse notion
\begin{convention}
    The inverse notion
    \begin{itemize}
        \item $+^{-1} = -$
...
In fact, the initial operand can be any number. We have one expression and assume the operand is $\alpha$, the operations are
$a_1 a_2 ... a_{n-1} a_n$, and the result of the expression is $\beta$, hence we have
