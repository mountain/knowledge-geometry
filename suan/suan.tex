...
Arithmetical expression set $A_n$ is expressions freely generated from
\begin{itemize}
...
If we treat each elements of $A_n$ as a calculation path from $0$ by applying a serial of operators,
we will get the path group $\mathcal{P}$ which is obviously non-abelian.
