...
\section{The algebraic structure of arithmetical expressions}\label{sec:discrete}
...
so we can carry the computation by applying a serial of addition and multiplication on some numbers, or an arithmetical
expression.
