...
\section{A kind of new infinitesimal calculation}\label{sec:fgs}
...
\subsection{Two examples of the consistency}

Assuming $\theta = \pi / 4$ and $x_0 = 0$, we can conclude that
...
\begin{equation}
    x_{n+1} = e (x_n + 1) - 1, x_0 = 0
\end{equation}

\begin{equation}
    x_{n+1} = [+1*e-1] x_n, x_0 = 0
\end{equation}

Assuming $\theta = \pi / 6$ and $x_0 = 0$, we can conclude that
