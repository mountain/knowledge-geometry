...
\begin{abstract}
    ...
    consistency among the discrete constructions, infinitesimal computation and the hyperbolic geometrical structures, and
    these lead us to a new mathematical system $\mathfrak{S}$. It also shows surreal number can be embedded properly
    into $\mathfrak{S}$.
\end{abstract}

\keywords{hyperbolic surface \and addition-multiplication tree \and infinitesimal computation \and Suan system \and surreal number \and geometry of computation}

\setcounter{tocdepth}{2}
\tableofcontents

\section{Some discrete constructions on hyperbolic surface}\label{sec:fgs}

\subsection{Order-4 apeirogonal tiling and addition-multiplication tree}\label{sec:o4ataamt}
...
\subsection{Reverse Polish notation, recursion and discrete path on $\mathfrak{S}$}\label{sec:rpnradp}

\newpage

\section{A kind of new infinitesimal computation}\label{sec:fgs}

\subsection{Local polar coordinate and flow equation}\label{sec:lpcsafe}
...
\subsection{Driving chart of an evolutionary process}\label{sec:dcoaep}
...
\subsection{Other example functions}\label{sec:ef}
