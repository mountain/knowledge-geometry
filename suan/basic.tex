...
It is a fundamental goal to describe and understand a variation process in mathematics.

Newton and Leibniz introduced calculus as a tool to achieve this goal in the 1680s. The basic concept is derivatives, which linearize a small piece of changes over a short period, and the accumulate of derivatives over time gives to the original variation process. Back to the arithmetic level, we can treat this technique as a method by accumulating additions.

Except for the accumulation of additions, people also found the corresponding concept for accumulating multiplications. Napier discovered these concepts very before the invention of calculus; in 1614, Napier introduced logarithm function, and in 1618 he also discovered the nature exponent constant e. In the mathematical prescription of a variation process, people then widely used logarithm function and exponential function as tools.
